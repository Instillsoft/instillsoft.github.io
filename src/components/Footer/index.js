...
import { DribbbleIcon, GithubIcon, LinkedinIcon, TwitterIcon, YoutubeIcon } from "../Icons";
      ...
      */}
      ...
      <div className="w-full  mt-16 md:mt-24 relative font-medium border-t border-solid border-light py-6 px-8 flex  flex-col md:flex-row items-center justify-between">
        <span className="text-center">
          &copy;2024 Instillsoft Private Limited. All rights reserved.
        </span>
        <Link
          href="/sitemap.xml"
        ...
        <div className="text-center">
          Made with &hearts; by{" "}
          <a href="https://instilllearning.com" className="underline" target="_blank">
            Instill Learning
          </a>
        </div>
      </div>
